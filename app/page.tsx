...
// Fetch product data from centralized data file
...
export default function Home() {
  ...
  // No local cart state or addToCart logic here
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white text-[18px] w-full overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-blue-50/30 overflow-hidden w-full">
        {/* Centered, smaller background circle for glow */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[700px] h-[700px] sm:w-[1100px] sm:h-[1100px] rounded-full bg-gradient-to-br from-[#3AF0F7]/10 via-[#8ef7fb]/10 to-transparent z-0 pointer-events-none"></div>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8 md:px-16 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center min-h-[80vh] sm:min-h-[90vh] w-full">
            ...
            <div className="flex flex-col justify-center items-start space-y-5 sm:space-y-6 md:space-y-8 w-full max-w-xl mx-auto lg:mx-0 pt-8 sm:pt-12 lg:pt-0">
              ...
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-16 pt-8 sm:pt-10 border-t border-gray-200 w-full mt-6">
                <div className="flex flex-col items-center sm:pr-12 border-r-0 sm:border-r border-gray-300 last:border-none">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">47</div>
                  <div className="text-base text-gray-600">Orders today</div>
                </div>
                <div className="flex flex-col items-center sm:px-12 border-r-0 sm:border-r border-gray-300 last:border-none">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">7000+</div>
                  <div className="text-base text-gray-600">Orders</div>
                </div>
                <div className="flex flex-col items-center sm:pl-12">
                  <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">4000+</div>
