...
export const SingleProductCard: React.FC<SingleProductCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Product image */}
      <div className="absolute left-1/2 top-[20px] sm:top-[38px] -translate-x-1/2 w-[80px] h-[80px] w-[180px] h-[180px] sm:w-[240px] sm:h-[240px] flex items-center justify-center">
