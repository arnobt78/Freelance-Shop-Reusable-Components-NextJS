  ...
  <div className="flex flex-col gap-4 mt-4 w-full px-4 sm:px-0">
    <div className="flex flex-row items-center gap-4">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[13px] text-gray-400 leading-tight">2-3 business days</span>
      </div>
    </div>
    <div className="flex flex-row items-center pt-2 gap-4">
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[13px] text-gray-400 leading-tight">Tomorrow</span>
      </div>
    </div>
    <div className="flex flex-row items-center pt-2 gap-4">
      {/* Store Icon */}
      ...
      <div className="flex flex-col">
        ...
        <span className="text-[13px] text-gray-400 leading-tight">Today (Wroclaw)</span>
      </div>
    </div>
  </div>
);
